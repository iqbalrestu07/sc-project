...
type Commission struct {
	...
	// CommissionReason distinguishes why the commission was earned:
	//   "handling" = staff adalah PIC tindakan (selalu diberikan jika staff di-assign)
	//   "offering" = staff menawarkan tindakan dan pasien setuju (opsional)
	//   nil/empty = data lama sebelum fitur ini ditambahkan
	CommissionReason *string    `json:"commission_reason,omitempty" db:"commission_reason"`
